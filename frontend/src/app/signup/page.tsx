...
import { Mail, Lock, Eye, EyeOff, Loader2, ClipboardList, Shield } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errMsg = err instanceof Error ? err.message : 'Registration failed. Email might already be taken.';
      setError(errMsg);
    } finally {
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2.5 text-sm text-slate-400">
            Get started with AetherTasks today
          </p>
        </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <button
                  ...
                  className={`py-3 px-4 rounded-xl border text-sm font-semibold transition duration-150 flex items-center justify-center gap-2 ${
                    role === 'user'
